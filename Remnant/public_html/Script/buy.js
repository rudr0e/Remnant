  ...
  "Paper is a valuable recyclable material but only when it is clean. If you scrunch paper and it doesn't spring back, then it can be recycled." },
{
  ...
  qty: 10,
  heading: "Glass scrap 1 unit per 10kg",
  des:
  "Glass bottles and jars are infinitely recyclable.Glass is ideal for recycling since none of the material is degraded by normal use." },
{
  ...
  qty: 15,
  heading: "Metal scrap 1 unit per 10kg",
  des:
  "These are hard object made out of metal a can, toy, tool, or car part .Popular metals are Aluminum, Brass and Bronze, Cast Iron, Copper, Tin and Steel." },
{
  ...
  qty: 30,
  heading: "E-waste scrap 1 unit per 10kg",
  des:
  "contain a range of materials including metals, plastics and several valuable components - such as silver - which can be extracted and re-used." },
{
  ...
  qty: 25,
  heading: "Plastic scrap 1 unit per 10kg",
  des:
...
<div class='side-nav'>
  ...
  <div class='final'>
    ...
    <div class='action'>
      <button onclick='buy(1)' class='btn buy'>Purchase <i class='fas fa-credit-card' style='color:#4f1363;'></i></button>       <button onclick='clearCart()' class='btn clear'>Clear Cart <i class='fas fa-trash' style='color:#631313;'></i></button>
    </div>
  </div>
</div>`;
}
...
<hr>
 ...
 <div>
  ...
  <div> <p>Shipping Charges:</p><span class='pay'>₹ ${100} </span> </div>
...
<div>
  <div class='order-details'>
    ...
    <p>You can pay <span>₹ ${totalCost+(totalCost*18/100)+150}</span> by card or any online transaction method after the products have been delivered to you</p>
  </div>
